...
enum {
    ...
    USB_CDC_INTERFACE_CONTROL,
    USB_CDC_INTERFACE_DATA,
    USB_MIDI_INTERFACE_COUNT,
    USB_MIDI_ENDPOINT_OUT = 0x01U,
    USB_MIDI_ENDPOINT_IN = 0x81U,
    USB_CDC_ENDPOINT_NOTIFICATION = 0x82U,
    USB_CDC_ENDPOINT_OUT = 0x02U,
    USB_CDC_ENDPOINT_IN = 0x83U,
    USB_MIDI_ENDPOINT_SIZE = 64U,
    USB_MIDI_PRODUCT_ID = 0x4009U,
    USB_MIDI_CONFIGURATION_LENGTH = TUD_CONFIG_DESC_LEN + TUD_MIDI_DESC_LEN + TUD_CDC_DESC_LEN,
...
static const uint8_t configuration_descriptor[] = {
    ...
    TUD_CDC_DESCRIPTOR(
        USB_CDC_INTERFACE_CONTROL,
        0U,
        USB_CDC_ENDPOINT_NOTIFICATION,
        8U,
        USB_CDC_ENDPOINT_OUT,
        USB_CDC_ENDPOINT_IN,
        USB_MIDI_ENDPOINT_SIZE),
};
