...
/* Dedicated I2C bus for the OLED. */
#define BOARD_OLED_I2C_INSTANCE i2c0
#define BOARD_OLED_I2C_SDA_PIN 0u
#define BOARD_OLED_I2C_SCL_PIN 1u
#define BOARD_OLED_I2C_ADDRESS 0x3cu

/* Shared I2C bus for the expression ADC and footswitch expander. */
#define BOARD_INPUT_I2C_INSTANCE i2c1
#define BOARD_INPUT_I2C_SDA_PIN 2u
#define BOARD_INPUT_I2C_SCL_PIN 3u
...
#define BOARD_EXPRESSION_ADC_READY_PIN 6u
